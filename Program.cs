...
{ 
    ...
    class User
    {
        Dictionary<string,AddressBook> dic = new Dictionary<string,AddressBook>();
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Select an option to be performed by user");
            Console.WriteLine("1. To Add Person");
            Console.WriteLine("2. To perform operations");
            Console.WriteLine("3. TO Display");
            Console.WriteLine("4. Exit");

            int opinion = Convert.ToInt16(Console.ReadLine()); 
